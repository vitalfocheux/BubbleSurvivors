...
export class Axolotl extends Enemy {
    constructor(canvas){
        super(canvas, 15, 3, 7, 2.5, 7); // Call super constructor first
        if(super.getShiny()){
            super.setExp(15);
            super.setDamage(5);
            super.setLife(15);
        ...
        this.framesPerSprite = 13; // Number of game frames per sprite frame
    }
