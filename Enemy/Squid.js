...
export class Squid extends Enemy {
    constructor(canvas){
        super(canvas, 15, 1.5, 3, 2, 5); // Call super constructor first
        if(super.getShiny()){
            super.setExp(6);
            super.setDamage(4);
            super.setLife(10);
    ...
    loadSquidSprite() {
        ...
        for (let i = 1; i < numFrames; i++) {
            const img = new Image();
            img.src = super.getShiny() ? `assets/sprites/squid/squid_red_${i}.png` : `assets/sprites/squid/squid_pink_${i}.png`;
            img.onerror = () => {
